...
class BlueskyController < ApplicationController
  def get
    ...
    url = URI.parse(your_bluesky_domain + '/ETLog?instruction=sensornetwork&opt1=172.16.4.222&opt2=gpio&opt3=set&opt4=22&opt5=0')
    ...
    render :text => "We has set the value 0 to gpio pin number 22 of the local embedded device(ED) IP '172.16.4.222' of public domain #{your_bluesky_domain}. The operation result is '#{set_result}'"
  end
end
